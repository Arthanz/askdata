provider: `openai` · model: `gpt-5.4-mini` · tag: `gpt54mini-run3`

# AskData evaluation report — 2026-07-04 15:07
...
| abstained | 33 | 62 |
| correct | 116 | 109 |
| accuracy | 0.773 | 0.727 |
| accuracy_answerable | 0.72 | 0.653 |
| confidently_wrong | 32 | 11 |
| confidently_wrong_rate | 0.213 | 0.073 |
| hallucinated_unanswerable | 1 | 0 |
| repaired | 1 | 22 |
| repair_success | 0 | 16 |
| avg_attempts | 1.01 | 1.58 |
| avg_seconds | 2.95 | 4.84 |
| total_tokens | 147013 | 325183 |
...
| M9 | ambiguous | abstained | False | 2 | - |
...
| A9 | aggregation | repaired | True | 2 | - |
| A10 | aggregation | trusted | True | 1 | - |
| A11 | aggregation | trusted | True | 1 | - |
...
| J3 | join | abstained | False | 3 | static.select_only |
| J4 | join | trusted | True | 1 | - |
...
| J23 | join | trusted | True | 1 | - |
| J24 | join | repaired | True | 3 | - |
| J25 | join | trusted | True | 1 | - |
| J26 | join | repaired | True | 2 | - |
| J27 | join | repaired | False | 3 | - |
| J28 | join | trusted | True | 1 | - |
...
| T21 | temporal | trusted | True | 1 | - |
| T22 | temporal | trusted | False | 1 | - |
| T23 | temporal | abstained | False | 3 | static.select_only |
